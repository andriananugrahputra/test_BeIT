...
!(function (e) {
        ...
        (o = function (e, t, n, i) {
            ...
            function p(t, n) {
                function a(t, a, r) {
                    var o = !1;
                    if (
                        ((null !== t && "" !== t) || ((o = null !== r.regex) ? (t = (t = r.regex).replace(/^(\^)(.*)(\$)$/, "$2")) : ((o = !0), (t = ".*"))),
                    ...
                    return (
                        u.prototype.masksCache[c] === i || !0 === n
                            ? ((l = { mask: t, maskToken: u.prototype.analyseMask(t, o, r), validPositions: {}, _buffer: i, buffer: i, tests: {}, excludes: {}, metadata: a, maskLength: i }),
            ...
            function m(a, c, p) {
                ...
                function E(e, t, n, a, r) {
                    ...
                    do {
                        if (!0 === e && M().validPositions[f])
                            (l = (u =
                                !r || !0 !== M().validPositions[f].match.optionality || (!0 !== M().validPositions[f].generatedInput && M().validPositions[f].input != p.skipOptionalPartCharacter) || M().validPositions[f + 1] !== i
                                    ? M().validPositions[f]
                                    : D(f, N(f, s, f - 1))).match),
                                (s = u.locator.slice()),
                ...
                function D(e, t, n) {
                    for (
                        var a, r = T((e = e > 0 ? e - 1 : 0), t), o = r.alternation !== i ? r.locator[r.alternation].toString().split(",") : [], s = 0;
                        s < t.length &&
                        (!(
                            (a = t[s]).match &&
                            ((p.greedy && !0 !== a.match.optionalQuantifier) || ((!1 === a.match.optionality || !1 === a.match.newBlockMarker) && !0 !== a.match.optionalQuantifier)) &&
                            (r.alternation === i || r.alternation !== a.alternation || (a.locator[r.alternation] !== i && L(a.locator[r.alternation].toString().split(","), o)))
                        ) ||
                ...
                function N(t, n, a) {
                                    ...
                                    (s[0].alternation === i
                                        ...
                                        : e.each(s, function (e, t) {
                                              if ("" !== t.def)
                                                  ...
                                                  else for (var n = 0; n < l.length; n++) t.locator[n] && -1 === l[n].toString().indexOf(t.locator[n]) && (l[n] += "," + t.locator[n]);
                                          })),
                                (h = (f = l).join("")),
                                (c = k));
                        }
                    ...
                    return (
                        (0 === m.length || d) && m.push({ match: { fn: null, optionality: !0, casing: null, def: "", placeholder: "" }, locator: [], mloc: {}, cd: h }),
                    ...
                    function f(n, a, o) {
                        ...
                        return (
                            e.each(N(n), function (c, f) {
                                var m = f.match;
                                if ((I(!0), !1 !== (s = null != m.fn ? m.fn.test(a, M(), n, o, p, l(t)) : (a === m.def || a === p.skipOptionalPartCharacter) && "" !== m.def && { c: $(n, m, !0) || m.def, pos: n }))) {
                                    var d = s.c !== i ? s.c : a,
                                        h = n;
                                    return (
                            ...
                            var s = function (t) {
                                ...
                                if (n.inputmask === i && "FORM" !== this.nodeName) {
                                    ...
                                    if (
                                        "setvalue" === t.type ||
                                        "FORM" === this.nodeName ||
                                        !(n.disabled || (n.readOnly && !(("keydown" === t.type && t.ctrlKey && 67 === t.keyCode) || (!1 === p.tabThrough && t.keyCode === u.keyCode.TAB))))
                                    ) {
                                        switch (t.type) {
                                            case "input":
                    ...
                    Y = {
                        keydownEvent: function (t) {
                            var n = this,
                                ...
                                a = t.keyCode,
                                r = ne(n);
                            if (a === u.keyCode.BACKSPACE || a === u.keyCode.DELETE || (l && a === u.keyCode.BACKSPACE_SAFARI) || (t.ctrlKey && a === u.keyCode.X && !f("cut")))
                                ...
                                (a === u.keyCode.HOME && !t.shiftKey) || a === u.keyCode.PAGE_UP
                                    ...
                                    ? !0 === p.tabThrough && a === u.keyCode.TAB
                                        ? (!0 === t.shiftKey
                                              ? (null === T(r.begin).match.fn && (r.begin = q(r.begin)), (r.end = Q(r.begin, !0)), (r.begin = Q(r.end, !0)))
                                    ...
                                    : ((p.insertMode = !p.insertMode), ne(n, p.insertMode || r.begin !== M().maskLength ? r.begin : r.begin - 1));
                        ...
                        keypressEvent: function (t, n, a, r, o) {
                            ...
                            if (c) {
                                ...
                                var k = V(m, h, r);
                                if (
                                    (!1 !== k && (w(!0), (f = k.caret !== i ? k.caret : q(k.pos.begin ? k.pos.begin : k.pos)), (M().p = f)),
                        ...
                        inputFallBackEvent: function (t) {
                            ...
                            if (I().join("") !== r) {
                                ...
                                if (
                                    ((i = s),
                                    "." === (n = r).charAt(i.begin - 1) && "" !== p.radixPoint && (((n = n.split(""))[i.begin - 1] = p.radixPoint.charAt(0)), (n = n.join(""))),
                                    (r = (function (e, t, n) {
                                        if (o) {
                                    ...
                                    if (
                                        (m !== h &&
                                            (m.length > h.length
                                                ? (v += m.slice(0, 1))
                                                : m.length < h.length && ((g.end += h.length - m.length), k || "" === p.radixPoint || "" !== m || f.charAt(g.begin + c - 1) !== p.radixPoint || (g.begin--, (v = p.radixPoint)))),
                        ...
                        setValueEvent: function (t) {
                            ...
                            e.isFunction(p.onBeforeMask) && (n = p.onBeforeMask.call(k, n, p) || n),
                                ...
                                (d = I().join("")),
                                (p.clearMaskOnLostFocus || p.clearIncomplete) && this.inputmask._valueGet() === G().join("") && this.inputmask._valueSet("");
                        },
                        focusEvent: function (e) {
                            var t = this,
                                n = t.inputmask._valueGet();
                            p.showMaskOnFocus && (!p.showMaskOnHover || (p.showMaskOnHover && "" === n)) && (t.inputmask._valueGet() !== I().join("") ? W(t, I(), q(O())) : !1 === A && ne(t, q(O()))),
                        ...
                        submitEvent: function (e) {
                            d !== I().join("") && h.trigger("change"),
                                p.clearMaskOnLostFocus && -1 === O() && y.inputmask._valueGet && y.inputmask._valueGet() === G().join("") && y.inputmask._valueSet(""),
                                ...
                                if (M().validPositions[n] === i && s[n] === $(n) && z(n, !0) && !1 === V(n, s[n], !0, i, i, !0)) M().p++;
                                    ...
                                    if (
                                        ...
                                        -1 === E(!0, 0, !1).slice(g, q(g)).join("").indexOf(v) ||
                                            z(g) ||
                                            (T(g).match.nativeDef !== v.charAt(0) && (" " !== T(g).match.nativeDef || T(g + 1).match.nativeDef !== v.charAt(0))) ||
                                            a ||
                                            p.autoUnmask)
                                    ) {
                ...
                function ne(a, r, o, s) {
                    ...
                    if (r === i)
                        return (
                            a.setSelectionRange
                                ...
                                : t.getSelection
                                ? ((u = t.getSelection().getRangeAt(0)).commonAncestorContainer.parentNode !== a && u.commonAncestorContainer !== a) || ((r = u.startOffset), (o = u.endOffset))
                                : n.selection && n.selection.createRange && (o = (r = 0 - (u = n.selection.createRange()).duplicate().moveStart("character", -a.inputmask._valueGet().length)) + u.text.length),
                    ...
                    if ((e.isArray(r) && ((o = b ? r[0] : r[1]), (r = b ? r[1] : r[0])), r.begin !== i && ((o = b ? r.begin : r.end), (r = b ? r.end : r.begin)), "number" == typeof r)) {
                        ...
                        if (((a.scrollLeft = c > a.scrollWidth ? c : 0), l || !1 !== p.insertMode || r !== o || o++, (a.inputmask.caretPos = { begin: r, end: o }), a.setSelectionRange)) (a.selectionStart = r), (a.selectionEnd = o);
                        ...
                        ((a = l[n]).match.optionality ||
                            ...
                            (p &&
                                ((p !== l[n].locator[u.alternation] && null != a.match.fn) ||
                                    (null === a.match.fn && a.locator[u.alternation] && L(a.locator[u.alternation].toString().split(","), p.toString().split(",")) && "" !== N(n)[0].def)))) &&
                        r[n] === $(n, a.match);
                        n--
                    )
                        o--;
                ...
                function oe(e, t, n, a, r) {
                    ...
                    if (
                        (t === u.keyCode.BACKSPACE && (n.end - n.begin < 1 || !1 === p.insertMode)
                            ? ((n.begin = Q(n.begin)), M().validPositions[n.begin] !== i && M().validPositions[n.begin].input === p.groupSeparator && n.begin--, !1 === p.insertMode && n.end !== M().maskLength && n.end--)
                            : t === u.keyCode.DELETE &&
                              n.begin === n.end &&
                              ((n.end = z(n.end, !0) && M().validPositions[n.end] && M().validPositions[n.end].input !== p.radixPoint ? n.end + 1 : q(n.end) + 1),
                    ...
                    else if (!0 !== a && ((M().p = n.begin), !0 !== r)) for (; M().p < c && M().validPositions[M().p] === i; ) M().p++;
                }
                function se(i) {
                        ...
                        if ((t === i ? (t = ne(e)) : t.begin === i && (t = { begin: t, end: t }), !0 !== a)) {
                            ...
                            do {
                                M().validPositions[c]
                                    ...
                                    : ((o = F(c, s, c - 1)), (r = o.match), (s = o.locator.slice()), !1 === p.jitMasking || c < d || ("number" == typeof p.jitMasking && isFinite(p.jitMasking) && p.jitMasking > c) ? f($(c, r)) : (u = !1)),
                                    c++;
                            } while (((g === i || c < g) && (null !== r.fn || "" !== r.def)) || d > c || u);
                            u && f(),
                                n.activeElement === e &&
                                    (l.splice(t.begin, 0, t.begin === t.end || t.end > M().maskLength ? '<mark class="im-caret" style="border-right-width: 1px;border-right-style: solid;">' : '<mark class="im-caret-select">'),
                    ...
                    switch (a.action) {
                            ...
                            !(function (t) {
                                                  ...
                                                  if (!t.inputmask.__valueGet) {
                                                      if (!0 !== a.noValuePatching) {
                                                          if (Object.getOwnPropertyDescriptor) {
                                                              ...
                                                              p && p.get && p.set
                                                                  ? ((r = p.get), (o = p.set), Object.defineProperty(t, "value", { get: u, set: c, configurable: !0 }))
                                                                  : "INPUT" !== t.tagName &&
                                                                    ((r = function () {
                                                              ...
                                                              n.__lookupGetter__ &&
                                                                  ...
                                                                  ((r = t.__lookupGetter__("value")), (o = t.__lookupSetter__("value")), t.__defineGetter__("value", u), t.__defineSetter__("value", c));
                                ...
                                if (
                                    ...
                                    r &&
                                        ...
                                        !0 === p.disablePredictiveText && ("autocorrect" in y ? (y.autocorrect = !1) : (!0 !== p.colorMask && se(y), (y.type = "password")))),
                                    !0 === a &&
                                        (J.on(y, "submit", Y.submitEvent),
                                        J.on(y, "reset", Y.resetEvent),
                                        J.on(y, "blur", Y.blurEvent),
                                        J.on(y, "focus", Y.focusEvent),
                                        !0 !== p.colorMask && (J.on(y, "click", Y.clickEvent), J.on(y, "mouseleave", Y.mouseleaveEvent), J.on(y, "mouseenter", Y.mouseenterEvent)),
                                        ...
                                        r || !0 === p.inputEventOnly ? y.removeAttribute("maxLength") : (J.on(y, "keydown", Y.keydownEvent), J.on(y, "keypress", Y.keypressEvent)),
                        ...
                        case "format":
                            return (
                                ...
                                a.metadata ? { value: b ? I().slice().reverse().join("") : I().join(""), metadata: m.call(this, { action: "getmetadata" }, c, p) } : b ? I().slice().reverse().join("") : I().join("")
                            );
                        case "isValid":
                        ...
                        case "remove":
                            if (y && y.inputmask)
                                e.data(y, "_inputmask_opts", null),
                                    ...
                                    J.off(y),
                                    y.inputmask.colorMask && ((v = y.inputmask.colorMask).removeChild(y), v.parentNode.insertBefore(y, v), v.parentNode.removeChild(v)),
            ...
            return (
                (u.prototype = {
                    ...
                    unmaskedvalue: function (e) {
                        return (this.maskset = this.maskset || p(this.opts, this.noMasksCache)), m.call(this, { action: "unmaskedvalue", value: e });
                    },
                    remove: function () {
                    ...
                    isValid: function (e) {
                        return (this.maskset = this.maskset || p(this.opts, this.noMasksCache)), m.call(this, { action: "isValid", value: e });
                    },
                    format: function (e, t) {
                        return (this.maskset = this.maskset || p(this.opts, this.noMasksCache)), m.call(this, { action: "format", value: e, metadata: t });
                    },
                    setValue: function (t) {
                        ...
                        function y(t, r, o) {
                            ...
                            if (n)
                                0 === r.indexOf("[") || (d && /\\d|\\s|\\w]/i.test(r)) || "." === r
                                    ? t.matches.splice(o++, 0, { fn: new RegExp(r, a.casing ? "i" : ""), optionality: t.isOptional, newBlockMarker: s === i || s.def !== r, casing: null, def: r, placeholder: i, nativeDef: r })
                                    : (d && (r = r[r.length - 1]),
                    ...
                    "year" === r
                        ? ((e[r] =
                              ...
                              i.min && i.min.year && i.max && i.max.year
                                  ? ((o = o.replace(/[^0-9]/g, "")),
                                    (o += i.min.year == i.max.year ? i.min.year.substr(o.length) : ("" !== o && 0 == i.max.year.indexOf(o) ? parseInt(i.max.year) - 1 : parseInt(i.min.year) + 1).toString().substr(o.length)))
                                  : (o = o.replace(/[^0-9]/g, "0")),
                              o)),
                          (e["raw" + r] = t))
                        ...
                        postValidation: function (e, t, n) {
                            ...
                            return (
                                u &&
                                    ...
                                    (l = u),
                                    (u =
                                        (u = (!isFinite(o.day) || ("29" == o.day && !isFinite(o.rawyear)) || new Date(o.date.getFullYear(), isFinite(o.month) ? o.month : o.date.getMonth() + 1, 0).getDate() >= o.day) && l) &&
                                        ((i = c),
                                        (r = !0),
                                        (a = n).min && a.min.date.getTime() == a.min.date.getTime() && (r = a.min.date.getTime() <= i.date.getTime()),
                                        r && a.max && a.max.date.getTime() == a.max.date.getTime() && (r = a.max.date.getTime() >= i.date.getTime()),
                                        r))),
                                u
                            );
                        },
    ...
    function (e, t, n) {
        ...
        (o = function (e, t) {
            return (
                t.extendDefinitions({ A: { validator: "[A-Za-zА-яЁёÀ-ÿµ]", casing: "upper" }, "&": { validator: "[0-9A-Za-zА-яЁёÀ-ÿµ]", casing: "upper" }, "#": { validator: "[0-9A-Fa-f]", casing: "upper" } }),
                t.extendAliases({
                ...
                t.extendAliases({
                    numeric: {
                        mask: function (e) {
                            ...
                            if (((r += i(e.prefix, e)), !0 === e.integerOptional ? (r += "~{1," + e.integerDigits + "}") : (r += "~{" + e.integerDigits + "}"), e.digits !== n)) {
                                ...
                                isFinite(s[0]) && s[1] && isFinite(s[1])
                                    ? (r += o + ";{" + e.digits + "}")
                                    : (isNaN(e.digits) || parseInt(e.digits) > 0) && (e.digitsOptional ? (r += "[" + o + ";{1," + e.digits + "}]") : (r += o + ";{" + e.digits + "}"));
                            }
                        ...
                        preValidation: function (t, i, a, r, o, s) {
                            if ("-" === a || a === o.negationSymbol.front) return !0 === o.allowMinus && ((o.isNegative = o.isNegative === n || !o.isNegative), "" === t.join("") || { caret: i, dopost: !0 });
                        ...
                        postValidation: function (i, a, r) {
                            ...
                            c !== n &&
                                ...
                                r.prefix.length > 0 && l >= (!1 === r.isNegative ? 1 : 0) && l < r.prefix.length - 1 + (!1 === r.isNegative ? 1 : 0)
                                    ...
                                    : r.suffix.length > 0 && l >= u.length - r.suffix.length - (!1 === r.isNegative ? 1 : 0) && (o[l - (u.length - r.suffix.length - (!1 === r.isNegative ? 1 : 0))] = "?")),
                                (s = s.join("")),
                                (o = o.join(""));
                            var p = u.join("").replace(s, "");
                            if (
                                ((p = (p = (p = (p = p.replace(o, "")).replace(new RegExp(t.escapeRegex(r.groupSeparator), "g"), "")).replace(new RegExp("[-" + t.escapeRegex(r.negationSymbol.front) + "]", "g"), "")).replace(
                                    new RegExp(t.escapeRegex(r.negationSymbol.back) + "$"),
                                    ""
                                )),
                                isNaN(r.placeholder) && (p = p.replace(new RegExp(t.escapeRegex(r.placeholder), "g"), "")),
                                p.length > 1 && 1 !== p.indexOf(r.radixPoint) && ("0" === c && (p = p.replace(/^\?/g, "")), (p = p.replace(/^0/g, ""))),
                                ...
                                if (((p = p.split("")), (!r.digitsOptional || (r.enforceDigitsOnBlur && "blur" === a.event)) && isFinite(r.digits))) {
                                    ...
                                    for (var d = 1; d <= r.digits; d++)
                                        (r.digitsOptional && (!r.enforceDigitsOnBlur || "blur" !== a.event)) || (p[f + d] !== n && p[f + d] !== r.placeholder.charAt(0))
                            ...
                            var v = { caret: c === n || a.pos !== n ? l + (r.numericInput ? -1 : 1) : l, buffer: p, refreshFromBuffer: a.dopost || i.join("") !== p.join("") };
                                ...
                                switch (i.type) {
                                    ...
                                    case "checkval":
                                        ...
                                        if (
                                            ...
                                            if (((s = o.onUnMask(a.join(""), n, e.extend({}, o, { unmaskAsNumber: !0 }))), null !== o.min && s < o.min))
                        ...
                        definitions: {
                            "~": {
                                validator: function (e, i, a, r, o, s) {
                                    ...
                                    } else r || e !== o.radixPoint || i.validPositions[a - 1] !== n || (l = { insert: { pos: a, c: 0 }, pos: a + 1 });
                                    return l;
                                },
                                cardinality: 1,
                            },
                        ...
                        isComplete: function (e, n) {
                            ...
                            return (
                                (a = (a = (a = (a = a.replace(new RegExp(t.escapeRegex(n.negationSymbol.back) + "$"), "")).replace(n.prefix, "")).replace(n.suffix, "")).replace(
                            ...
                            (a.phoneCodes &&
                                ...
                                (t = (function t(n) {
                                    var i = "",
                                        r = [];
                                    for (var o in n)
                                        e.isArray(n[o]) ? (1 === n[o].length ? r.push(o + n[o]) : r.push(o + a.groupmarker[0] + n[o].join(a.groupmarker[1] + a.alternatormarker + a.groupmarker[0]) + a.groupmarker[1])) : r.push(o + t(n[o]));
